        ...
        <div class="row g-5 mb-5 align-items-center">
            <div class="col-lg-7">
                <div class="position-relative mx-auto">
                    <h1 class="text-white mb-4">Pandanan Marine Technopark</h1>
                </div>
            </div>
            <div class="col-lg-5">
    ...
    <div class="container">
        <div class="row g-4 align-items-center">
            <div class="col-md-6 text-center text-md-start mb-md-0">
                <span class="text-body"><a href="#" class="border-bottom text-white"><i class="fas fa-copyright text-light me-2"></i>Pandanan Marine Technopark</a>, All right reserved.</span>
            </div>
